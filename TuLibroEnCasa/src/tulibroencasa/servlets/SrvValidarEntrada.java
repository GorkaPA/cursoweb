...
import tulibroencasa.bd.BdBase;
import tulibroencasa.bd.BdOperaciones;
import tulibroencasa.config.Configuracion;
import tulibroencasa.config.GestorConfiguracion;
...
public class SrvValidarEntrada extends HttpServlet {
	...
	public void init(ServletConfig config) throws ServletException {
		...
		// fichero_propiedades está definido en WEB.xml
